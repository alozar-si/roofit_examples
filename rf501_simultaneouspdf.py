...
data_ctl = model_ctl.generate(x, 20000)
...
frame1 = x.frame(ROOT.RooFit.Title("Physics sample"))
...
simPdf.plotOn(frame1, ROOT.RooFit.Components("px"), ROOT.RooFit.Slice(sample, "physics"), ROOT.RooFit.ProjWData(sampleSet, combData), ROOT.RooFit.LineStyle(ROOT.kDashed))
simPdf.plotOn(frame1, ROOT.RooFit.Slice(sample, "physics"), ROOT.RooFit.ProjWData(sampleSet, combData))
...
simPdf.plotOn(frame2, ROOT.RooFit.Slice(sample, "control"), ROOT.RooFit.ProjWData(sampleSet, combData))
simPdf.plotOn(frame2, ROOT.RooFit.Slice(sample, "control"), ROOT.RooFit.Components("px_ctl"), ROOT.RooFit.ProjWData(sampleSet, combData), ROOT.RooFit.LineStyle(ROOT.kDashed))
