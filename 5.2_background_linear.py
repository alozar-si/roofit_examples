...
hh.Write()
_file0.Close()"""
_file0 = TFile("data_gaus_linear.root", "READ")
hh = _file0.Get("hh")
...
sigma = RooRealVar("sigma","WidthofGaussian",3,0.01,5)
...
model = RooAddPdf("model", "model", RooArgList(gauss, bkg_lin), RooArgList(f))
